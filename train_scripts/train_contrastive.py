...
from src.utils.losses import similarity_matrix, contrastive_loss, clip_loss, max_margin_loss
            ...
            for images, captions, context_masks, predict_masks in pbar:
                ...
                for i in range(0, len(images), mini_batch_size):
                    ...
                    with torch.cuda.amp.autocast(dtype=torch.bfloat16, enabled=True):
                        ...
                        c_loss = max_margin_loss(representation_predicted, representation_target)
...
def main():
    train(
        num_epochs=100, 
        max_images_per_epoch=60*3, # 50000 
